...
<?PHP
          if($PNA_NOMBRE!=NULL or $PNA_APELLIDO!=NULL)
            {        
				  ...
				  $consulta = "select * from personas where (PNA_NOMBRE like '$PNA_NOMBRE' or PNA_APELLIDO like '$PNA_APELLIDO') AND PNA_SEXO=1 ORDER BY PNA_FECHA_FINAL ASC"or die(mysql_error());
            ...
            {     
                  include 'PHP/conexion.php';
				  	  ...
				  	  $consulta = "select * from personas WHERE PNA_SEXO=1  ORDER BY PNA_FECHA_FINAL ASC"or die(mysql_error());
