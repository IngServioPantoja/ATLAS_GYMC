...
<body>
  <div name='div_consultar_clientes' id='div_consultar_clientes' >
    <form name="formulario_pagos" action="lista_hombre.php" method="post" target='internal_lista'><table width="100%" border="0" id='tabla_estatica'>
      <tr>
    <td width="38%" height="50"><p id='titulo_formulario_inscripcion'>Consultar Hombres ATLAS GYM</p></td>
    ...
    <td width="20%"><input type='text' name='PNA_APELLIDO' placeholder='Apellido' onKeyUp='submit();'></td>
        ...
        <table width="100%" border="0" id='internal_lista'>
          <tr>
            ...
            <object type="text/html" name='internal_lista' data='lista_hombre.php'> </object></td>
          </tr>
        </table>
</table>
  </div>
